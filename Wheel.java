...
class records {
static String dob,persona,today,lky_stn,lky_no,keyf;
    int key;
}
class node{
int [] a=new int[5];
...
public void insert(int key)
	{
		...
		promote(leaf,key,null);
		 System.out.print("---------------\n");
		try{  
                     File fle = new File("D:\\fsmini\\traverse.txt");
		  ...
		  System.out.print("---------------- \n");
                  try{ 
                      FileWriter fw=new FileWriter("D:\\fsmini\\traverse.txt",true);
                        fw.write("-----------------\n");
                        fw.close();
                    }
                    catch(Exception e)
...
void traverse(node ptr){
                 ...
                 for(int i = 0; i < ptr.size; i++)
                {
                  ...
                  try{  FileWriter fw=new FileWriter("D:\\fsmini\\traverse.txt",true);
                    fw.write(ptr.a[i]+" ");
                    fw.close();
                }
...
no1=0;
try {
          File fle = new File("D:\\fsmini\\det.txt");
          if (fle.createNewFile()){
            System.out.println("File is created!");
            }else{
            System.out.println("File already exists.");
...
BufferedReader reader = new BufferedReader(new FileReader("D:\\fsmini\\det.txt"));
String line;
